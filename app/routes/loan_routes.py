...
router = APIRouter(prefix="/loans", tags=["Loans"], responses={404: {"description": "Usuario, dispositivo o préstamo inexistente"}, 409: {"description": "Equipo no disponible o préstamo ya devuelto"}})
...
def list_loans(filters: dict = Depends(loan_filters), db: Session = Depends(get_db)):
